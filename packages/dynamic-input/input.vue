<template>
  ...
  <el-date-picker v-else-if="type === 'date'" class="dynamic-input" v-model="_value" :size="size" :disabled="disabled" type="datetime" value-format="yyyyy-MM-dd-HH:mm" :placeholder="placeholder"></el-date-picker>
</template>
